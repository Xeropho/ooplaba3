...
namespace ooplaba3.Controllers
{
    public class ArtistSongsController : Controller
    {
        private readonly ApplicationContext _context;

        public ArtistSongsController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        {
            var applicationContext = _context.ArtistSongs.Include(a => a.Artist).Include(a => a.Song);
